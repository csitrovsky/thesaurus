...
class System extends Customers
{

    #   ... [%] ~@
    //  ...
    protected static string $version = 'beta';
    ...
    #   ... [%] ~@
    //  ...
    protected static array $routes_mapping = array();

    #   ... [%] ~@
    //  ...
    public static array $http_status_codes = array(
        #   ... 1xx Informational
        ...
        506 => 'Variant Also Negotiates (Experimental)',                507 => 'Insufficient Storage (WebDAV)',
        508 => 'Loop Detected (WebDAV)',                                509 => 'Bandwidth Limit Exceeded (Apache)',
        510 => 'Not Extended',                                          511 => 'Network Authentication Required',
        520 => 'Unknown Error',                                         598 => 'Network read timeout error',
